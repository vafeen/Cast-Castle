...
public class InnerLevel3B {
    private final List<InnerLevel4B> inner1Level4;
    private final InnerLevel4B inner2Level4;

    public InnerLevel3B(List<InnerLevel4B> inner1Level4, InnerLevel4B inner2Level4) {
        this.inner1Level4 = inner1Level4;
        this.inner2Level4 = inner2Level4;
    }

    public List<InnerLevel4B> getInner1Level4() {
        return inner1Level4;
    }
